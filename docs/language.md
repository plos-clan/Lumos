...
- **[词法定义](lexical/index.md)**: 包含注释规范、字面量（数字、字符串）、标识符命名规则及符号。
- **[语法核心](grammar/index.md)**: 详细描述变量声明、函数类型（`def`/`fun`/`act`）、控制流、类型系统及类与对象。
...
若要查看具体的关键字列表，请参阅 [关键字参考](grammar/keyword.md)。
