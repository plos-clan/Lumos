...
!!! quote
    ...
    ![你这比C++还复杂](../assets/rant/你这比C++还复杂.png)

!!! quote

    ![文本替换宏](../assets/rant/文本替换宏.png)

!!! quote

    ![感觉这么多语法，复杂度不比cpp低了](../assets/rant/感觉这么多语法，复杂度不比cpp低了.png)

!!! quote

    ![依托答辩](../assets/rant/依托答辩.png)

:::

!!! quote

    ![def第一反应有时候不知道是函数还是啥](../assets/rant/def第一反应有时候不知道是函数还是啥.png)
