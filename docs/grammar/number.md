...
<span style="color:green">如果要访问数字字面量隐式类型提升为类后的成员，请使用 `(123).xxx` 这样的写法</span>

尾随下划线是不被允许的，如：`123_` 会导致报错<br>
*<span style="color:red">error</span>: <span style="color:darkcyan">数字字面量中不允许尾随下划线</span>*
...
- 常规浮点数形式
  ...
  - 整数后加点 `123.`
  - 小数前加点 `.456`
- 科学计数法 `123e456` `123.456e789`<br>
  `e` 前可以有小数点，`e` 后不能有小数点<br>
...
- `i00` 有符号整数 (00 为位数) *<span style="color:orange">warning</span>: <span style="color:darkcyan">浮点字面量被转换为整数</span>*
- `u00` 无符号整数 (00 为位数) *<span style="color:orange">warning</span>: <span style="color:darkcyan">浮点字面量被转换为整数</span>*
- `f00` 浮点数 (00 为位数)
- `z` 高精度整数 *<span style="color:orange">warning</span>: <span style="color:darkcyan">浮点字面量被转换为整数</span>*
...
- 常规整数 `123i` `123_456i`
- 常规浮点数 `123.456i` `123.i` `.456i`
- 科学计数法 `123ie456` `123.456ie789`
